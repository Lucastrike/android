...
public class Level4 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        player1 = MediaPlayer.create(Level4.this, R.raw.up);
        player2 = MediaPlayer.create(Level4.this, R.raw.down);
        player3 = MediaPlayer.create(Level4.this, R.raw.bonus);
        player4 = MediaPlayer.create(Level4.this, R.raw.new_level);
    ...
    public void addFollowers(){
        ...
        follow.setText(Integer.toString(myScoreLvl4));
    ...
    public void timer(){
        ...
        CountDownTimer count = new CountDownTimer(40000, 1000) {
            ...
            public void onFinish() {
                ...
                if (myScoreLvl4 >= db.getScore(4).getScore()) {
                    db.updateScore(new Score(4, myScoreLvl4));
    ...
    public void clickMenu(View v){
        startActivity(new Intent(Level4.this, Grid_levels.class));
        this.finish();

        //Log.d("ScoreDataBase", String.valueOf(db.getScore(1).getScore()));
        if (myScoreLvl4 >= 260000) {
            ...
            CountDownTimer count = new CountDownTimer(1000, 1000) {
                ...
                public void onFinish() {
                    ...
                    LayoutInflater inflater = getLayoutInflater();
                    View layout = inflater.inflate(R.layout.congrat_toast_level5, null);
