...
public class Level6 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        player1 = MediaPlayer.create(Level6.this, R.raw.up);
        player2 = MediaPlayer.create(Level6.this, R.raw.down);
        player3 = MediaPlayer.create(Level6.this, R.raw.bonus);
        player4 = MediaPlayer.create(Level6.this, R.raw.new_level);
    ...
    public void addFollowers(){
        ...
        follow.setText(Integer.toString(myScoreLvl6));
    ...
    public void timer(){
        ...
        CountDownTimer count = new CountDownTimer(60000, 1000) {
            ...
            public void onFinish() {
                ...
                if (myScoreLvl6 >= db.getScore(6).getScore()) {
                    db.updateScore(new Score(6, myScoreLvl6));
    ...
    public void clickMenu(View v){
        startActivity(new Intent(Level6.this, Grid_levels.class));
        this.finish();

        //Log.d("ScoreDataBase", String.valueOf(db.getScore(1).getScore()));
        if (myScoreLvl6 >= 4500000) {
            ...
            CountDownTimer count = new CountDownTimer(1000, 1000) {
                ...
                public void onFinish() {
                    ...
                    soundNewLevel();
                    Toast t1 = Toast.makeText(getApplicationContext(), "endgame", Toast.LENGTH_LONG);

                    LayoutInflater inflater = getLayoutInflater();
                    View layout = inflater.inflate(R.layout.endgame, null);
