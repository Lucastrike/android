...
public class Level1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        player1 = MediaPlayer.create(Level1.this, R.raw.up);
        player2 = MediaPlayer.create(Level1.this, R.raw.down);
        player3 = MediaPlayer.create(Level1.this, R.raw.bonus);
        player4 = MediaPlayer.create(Level1.this, R.raw.new_level);
    ...
    public void addFollowers(){
        ...
        follow.setText(Integer.toString(myScoreLvl1));
    ...
    public void timer(){
        ...
        CountDownTimer count = new CountDownTimer(20000, 1000) {
            ...
            public void onFinish() {
                ...
                if (myScoreLvl1 >= db.getScore(1).getScore()) {
                    db.updateScore(new Score(1, myScoreLvl1));
    ...
    public void clickMenu(View v){
        startActivity(new Intent(Level1.this, Grid_levels.class));
        this.finish();
            ...
            if (myScoreLvl1 >= 1000) {
                ...
                CountDownTimer count = new CountDownTimer(1000, 1000) {
                    ...
                    public void onFinish() {
                        ...
                        LayoutInflater inflater = getLayoutInflater();
                        View layout = inflater.inflate(R.layout.congrat_toast_level2, null);
