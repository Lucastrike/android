...
public class Level2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        player1 = MediaPlayer.create(Level2.this, R.raw.up);
        player2 = MediaPlayer.create(Level2.this, R.raw.down);
        player3 = MediaPlayer.create(Level2.this, R.raw.bonus);
        player4 = MediaPlayer.create(Level2.this, R.raw.new_level);
    ...
    public void addFollowers(){
        ...
        follow.setText(Integer.toString(myScoreLvl2));
    ...
    public void timer(){
        ...
        CountDownTimer count = new CountDownTimer(20000, 1000) {
            ...
            public void onFinish() {
                ...
                if (myScoreLvl2 >= db.getScore(2).getScore()) {
                    db.updateScore(new Score(2, myScoreLvl2));
    ...
    public void clickMenu(View v){
        startActivity(new Intent(Level2.this, Grid_levels.class));
        this.finish();

        //Log.d("ScoreDataBase", String.valueOf(db.getScore(1).getScore()));
        if (myScoreLvl2 >= 11000) {
            ...
            CountDownTimer count = new CountDownTimer(1000, 1000) {
                ...
                public void onFinish() {
                    ...
                    LayoutInflater inflater = getLayoutInflater();
                    View layout = inflater.inflate(R.layout.congrat_toast_level3, null);
